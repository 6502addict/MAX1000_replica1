...
-- PERIPHERAL COMPONENTS
    ...
    component PIA_UART is
        port (
            ...
            serial_clk  : in  std_logic;                     -- 16X Serial clock
            reset_n     : in  std_logic;                     -- Active low reset
    ...
    component simple_timer is
        generic(CPU_SPEED_MHZ : integer := 1);
        port (
    ...
    -- EXPERIMENTAL UART not yet tested
...
-- END ROM PORT MAP
    ...
    sram_cs_n    <= '0' when vma = '1' and address_bus(15 downto 9)   = x"C" & "010"  else '1';   -- SHARED MEMORY
